        ...
        <>
            <div className='nav-main-content'>
                ...
                <div className='nav-elements'>
                    ...
                    <div ><CNavigation path='/' content={<img className='nav-icon-small' src="../images/reservation.svg" alt="home-icon-nav"/>} /></div>
                    <div ><CNavigation path='/' content={<img className='nav-icon-small' src="../images/historie.svg" alt="home-icon-nav"/>} /></div>
                </div>
